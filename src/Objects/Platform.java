...
public class Platform extends Object {
	...
	public Platform(PApplet sketch, int w, int h, PVector position) {
		...
		this.corner = new CollisionBox(this.position.x + this.width + 5, this.position.y + this.height - 30, 30, 30);
		this.colorWheel = new CollisionBox(this.position.x + this.width + 5, this.position.y + this.height - 65, 30, 30);
		this.delete = new CollisionBox(this.position.x + this.width + 5, this.position.y + this.height - 100, 30, 30);
	...
	public void UpdateStartPosition(float width, float height, PVector position) {
		...
		this.corner.Update(this.position.x + 5 + this.width, this.position.y + this.height - 30, 30, 30);
		this.colorWheel.Update(this.position.x + 5 + this.width, this.position.y + this.height - 65, 30, 30);
		this.delete.Update(this.position.x + 5 + this.width, this.position.y + this.height - 100, 30, 30);
	}
	...
	public void Draw() {
		...
		if (Globals.IS_EDITOR && Globals.IS_SHIFT_PRESSED) {
			...
			this.sketch.image(this.colorImage, this.position.x + this.width + 5, this.position.y + this.height - 65);

			this.sketch.rect(this.position.x + this.width + 5, this.position.y + this.height - 100, 30, 30);
			this.sketch.image(this.trashImage, this.position.x + this.width + 5, this.position.y + this.height - 100);
		}
	}
